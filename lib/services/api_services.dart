import 'dart:convert';
import 'dart:io';
import 'package:flutter_app_youtube_demo/models/youtube_video.dart';
...
class APIService {
  ...
  //searched videos
  Future<List<YoutubeVideo>> fetchYoutubeVideo({String query}) async {
    print('query $query');
    Map<String, String> parameters = {
      'part': 'snippet',
      'q': query,
    ...
    if (response.statusCode == 200) {
      ...
      _nextPageToken = data['nextPageToken'] ?? '';
      List<dynamic> svideosJson = data['items'];

      // Fetch first eight videos from uploads playlist
      List<YoutubeVideo> youtubeVideos = [];
      svideosJson.forEach(
        (json) => youtubeVideos.add(
